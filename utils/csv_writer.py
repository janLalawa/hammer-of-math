...
def write_results_to_csv(scenario_list: list[Scenario]) -> None:
    ...
    with open(Paths.SIMULATION_RESULTS_PATH, mode='w', newline='') as file:
        ...
        writer.writerow(['Attacker', 'Defender', 'Average Attacks', 'Average Hits', 'Average Wounds',
                         'Average Unsaved Saves', 'Average Damage', 'Average Damage Not FNP', 'Average Models Killed'])
